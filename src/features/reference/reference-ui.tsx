  ...
  return (
    <div className="space-y-3">
      {items.map((citation) => {
        ...
        return (
          <div key={citationKey(citation)} className="sub-frame rounded-md border border-[color:var(--border)] p-4">
              ...
              <div className="space-y-3">
                {results.map((record) => (
                  <button
                    ...
                    className="block w-full sub-frame rounded-md border border-[color:var(--border)] p-4 text-left transition hover:bg-[color:var(--surface-muted)]"
...
function KeyValueGrid({ items }: { items: Array<{ label: string; value: string | null | undefined }> }) {
  return (
    <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
      {items.map((item) => (
        <div key={item.label} className="sub-frame rounded-md border border-[color:var(--border)] p-4">
      ...
      <CardContent>
        <div className="space-y-3">
          {items.map((item, index) => (
            <div key={`${title}-${index}`} className="sub-frame rounded-md border border-[color:var(--border)] p-4 text-sm leading-6">
              {item}
            </div>
          ))}
        </div>
  ...
  return (
    <div className="space-y-4">
      {subsections.map((subsection) => (
        <div id={getRuleSubsectionAnchorId(subsection)} key={subsection.id} className="scroll-mt-24 sub-frame rounded-md border border-[color:var(--border)] p-4">
          <div className="flex flex-wrap items-center gap-2">
  ...
  return (
    <div className="space-y-4">
      ...
      {parsed.overrides.map((override) => (
        <div
          key={override.id}
          className="sub-frame sub-frame--accent rounded-md border border-[color:var(--accent)] bg-[color:color-mix(in_srgb,var(--accent)_10%,var(--surface))] p-4"
        >
          <div className="flex flex-wrap items-center gap-2">
            <Badge variant="accent">Changed or added</Badge>
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
          <Link className="sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]" to="/lore/factions/the-authority">
          ...
          <Link className="sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]" to="/forces/harlow-1st-reaction-force">
          ...
          <Link className="sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]" to="/scenarios/dockyard-assault">
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
          <Link className="sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]" to="/lore">
          ...
          <Link className="sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]" to="/forces">
          ...
          <Link className="sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]" to="/rules">
            <div className="font-medium">Rules</div>
            <p className="mt-2 text-sm text-[color:var(--muted-foreground)]">Core, matched play, USRs.</p>
          </Link>
          <Link className="sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]" to="/scenarios">
          ...
          <Link className="sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]" to="/builder">
          ...
          <Link className="sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]" to="/matches">
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {factions.map((faction) => (
            <Link
              key={faction.id}
              className="block sub-frame rounded-md border border-[color:var(--border)] p-4 transition hover:bg-[color:var(--surface-muted)]"
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {events.map((event) => (
            <article key={event.id} className="sub-frame rounded-md border border-[color:var(--border)] p-4">
                ...
                relatedForces.length > 0 ? (
                  <ul className="space-y-2">
                    {relatedForces.map((force) => (
                      <li key={force.id}>
                        <Link
                          className="block sub-frame rounded-md border border-[color:var(--border)] p-2 transition hover:bg-[color:var(--surface-muted)]"
                          to={`/forces/${force.id}`}
                        >
                          <div className="font-medium">{force.name}</div>
                    ...
                    <div>
                      ...
                      <div className="mt-3 space-y-3">
                        {faqEntries.slice(0, 4).map((entry) => (
                          <div key={entry.id} className="sub-frame rounded-md border border-[color:var(--border)] p-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {matchedPlayRules.map((rule) => (
            <div key={rule.id} className="sub-frame rounded-md border border-[color:var(--border)] p-4">
              <div className="flex flex-wrap items-center gap-2">
              ...
              <CardContent className="space-y-3">
                {unit.specialists.length > 0 ? (
                  unit.specialists.map((specialist) => (
                    <div key={specialist.id} className="sub-frame rounded-md border border-[color:var(--border)] p-4">
                      <div className="flex flex-wrap items-center gap-2">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {lore.data.glossary.map((term: GlossaryTerm) => (
            <div key={term.id} className="sub-frame rounded-md border border-[color:var(--border)] p-4">
              <div className="flex flex-wrap items-center gap-2">
